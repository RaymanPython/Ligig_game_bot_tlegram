...
class Pair:
    ...
    def finish(self, draw=False):
        ...
        if self.count_xod % 2 == 1:
            ...
            self.person1.update.message.reply_text(f'Увы, Вы проиграли, но не расстраивайтесь, в следующий раз Вам повезёт).\n'
            ...
            self.person2.update.message.reply_text(f'Увы, Вы проиграли, но не расстраивайтесь, в следующий раз Вам повезёт).\n'
...
TOKEN = '5310947155:AAEjJNTn0yFM2dJx3FX2Zq-ljT7CfA312YI'
def main():
